...
// void Vertin_Optimizer::Step1(ds_params_precision_t* grads,
...
//     auto it = invokers.find(std::tuple(state_type, state_type));
//     if (it == invokers.end()) {
//         throw std::runtime_error("Vertin optimizer with param type "s + c10::toString(params_type) +
